var GitHubLocales = function(locale) {
  var locales = {
    "zh-TW": {
      ...
      ".*github.com.*": [
        /* top nav-bar */
        ["ul.top-nav > li.explore > a", "", "瀏覽"], /* Explorer */
        ...
        ["ul.dashboard-tabs > li > a[href*=pulls]", "", "同步請求"], /* Pull Requests */
        ["ul.dashboard-tabs > li > a[href*=issues]", "", "議案列表"], /* Issues */
        ["ul.dashboard-tabs > li > a[href*=stars]", "", "收藏列表"], /* Stars */

        /* repository title bar */
        ["h1.entry-title.public > span.repo-label > span", "", "公開專案"], /* Public */
        ["h1.entry-title span.fork-flag > span.text", "func", function(el){el.html("由 " + $("h1.entry-title span.fork-flag > span.text > a")[0].outerHTML + " 分支而來")}], /* Forked from {repo_name} */
      ...
      "^http[s]?:\/\/github.com[\/]+$": [
        /* right sidebar */
        ["div.dashboard-sidebar h3.box-title:first", "", "您有貢獻的專案"], /* Repositories you contribute to */
        ["div.dashboard-sidebar h3.box-title:last", "func", function(el){el.html("您擁有的專案 " + $("div.dashboard-sidebar h3.box-title:last span.box-title-count")[0].outerHTML)}], /* Your repositories */
      ...
      "^http[s]?:\/\/github.com\/[^\/]+\/[^\/]+[\/]?$": [
        ...
        ["div.overall-summary ul.numbers-summary > li > a[href*=branches]", "func", function(el){el.html($("div.overall-summary ul.numbers-summary > li > a[href*=branches] span.num")[0].outerHTML + " 個旁支")}], /* {branches_count} Branches */
        ["div.overall-summary ul.numbers-summary > li > a[href*=releases]", "func", function(el){el.html($("div.overall-summary ul.numbers-summary > li > a[href*=releases] span.num")[0].outerHTML + " 次發佈")}], /* {releases_count} Releases */
        ...
        ["div.repository-sidebar div.repo-nav-contents ul.repo-menu li[original-title=Issues] span.full-word", "" ,"議案"], /* Issues */
        ["div.repository-sidebar div.repo-nav-contents ul.repo-menu li[original-title='Pull Requests'] span.full-word", "", "同步請求"], /* Pull Request */
        ["div.repository-sidebar div.repo-nav-contents ul.repo-menu li[original-title='Pulse'] span.full-word", "", "專案動態"], /* Pulse */
        ["div.repository-sidebar div.repo-nav-contents ul.repo-menu li[original-title='Graphs'] span.full-word", "", "統計圖表"], /* Graphs */
        ["div.repository-sidebar div.repo-nav-contents ul.repo-menu li[original-title='Network'] span.full-word", "","旁支總覽"], /* Network */
      ...
      "http[s]?:\/\/github.com\/[^\/]+\/[^\/]+\/issues": [
        /* tab navigation */
        ["div#issues_next > div.tabnav a[href$=issues]", "", "議案一覽"], /* Browse Issues */
        ["div#issues_next > div.tabnav a[href$=milestones]", "", "里程碑"], /* Milestones */
        ["div#issues_next div.tabnav a[href*=new]", "", "提新議案"], /* New Issue */

        /* left sidebar */
        ["div#issues_next ul.filter-list a[href*=issues]:first", "func", function(el){el.html($("div#issues_next ul.filter-list a[href*=issues]:first span.count")[0].outerHTML + " 所有議案")}], /* Everyone's Issues */
        ["div#issues_next ul.filter-list a[href*='issues/milestones'][href*=open]", "func", function(el){el.html($("div#issues_next ul.filter-list a[href*='issues/milestones'][href*=open] span.count")[0].outerHTML + " 進行中里程碑")}], /* Open Issues */
        ["div#issues_next ul.filter-list a[href*='issues/milestones'][href*=closed]", "func", function(el){el.html($("div#issues_next ul.filter-list a[href*='issues/milestones'][href*=closed] span.count")[0].outerHTML + " 已結案里程碑")}], /* Closed Issues */
